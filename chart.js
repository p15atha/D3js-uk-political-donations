...
/*Kanw load th vivliothkh mespeak kathws kai tis rithmiseis ths*/
...
//ALLAGH TWN TIMWN GIA TA KATALLHLA XRWMATA
...
function transition(name) {
	...
	/*Otan pathtei to kumpi Split by Amount
	 *tote kanei fadeOut ola ta alla views
	 *kai kanei fadeId to view tu view-by-amount
	 *epeita kanei return to kalesma ths amountSort*/
...
function start() {
	...
	.enter().append("circle")
		...
		//.style("opacity", 0.9)
		.attr("r", 0)
		//ANALOGA TO d.party ORIZETE KAI TO XRWMA
		...
		.on("click", mouseClick); //to node akousei sto mouseClick 
...
/*Thetei to force kathe mpalas kai kalei th byAmount*/
function amountSort() {
	force.gravity(0)
		.friction(0.8)
		.charge(function(d) { return -Math.pow(d.radius, 2.0) / 3; })
...
/*Gia kathe node kalaei th moveTobyAmount*/
function byAmount(e) {
...
function mouseover(d, i) {
	...
	//Kanei speech to donor name meta apo 0,5 deytera
...
function mouseout() {
	// no more tooltips
		...
		//Stamataei opoio setTimeout execution htan programatismeno
